...
## 数学思想来源
- 透镜：lenses/geometry.md（子空间分解、直和分解）、lenses/information.md（信息分解）
- 知识：knowledge-base/fundamentals/linear-algebra.md（直和分解 V = U ⊕ W、投影算子）、
  knowledge-base/fundamentals/information-theory.md（信息分解：shared/synergy/unique）
