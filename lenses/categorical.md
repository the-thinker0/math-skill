...
- `algebraic-geometry`：函子、自然变换、Yoneda 引理等范畴论结构（该知识库由此域承载）——跨域迁移的核心语言。**注意**：此域目前只有 sheaf-cohomology 与 grassmannian-plucker 两张锚点，没有专门的范畴论锚点；需要 Yoneda/极限/伴随等工具时预期走 Knowledge Gap Protocol 生成临时卡
